...
class Colors {
  ...
  public function __construct() {
    ...
    $this->background_colors['red'] = '41';//'41';
  ...
  public function str($string, $foreground_color = NULL, $background_color = NULL) {
    ...
    if (isset($this->background_colors[$background_color])) {
      $colored_padding .= "\033[" . $this->background_colors[$background_color] . "m" . $padding . "\033[0m";
      $colored_string .= "\033[" . $this->background_colors[$background_color] . "m";
    }

    if (isset($this->foreground_colors[$foreground_color]) || isset($this->foreground_colors[$foreground_color])) {
